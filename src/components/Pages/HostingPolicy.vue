    ...
    <v-container class="fill-height" fluid>
      <v-row justify="center">
        <v-col cols="8" class="policy-content text-body-1">
          <h1 class="mb-7" id="hosting-policy-for-wikibase-cloud">Hosting Policy for Wikibase Cloud (pilot version)</h1>
          <h2 class="mb-3" id="purpose-and-scope">1. Purpose and Scope</h2>
          ...
          <h2 class="mt-7 mb-3" id="principles">2. Principles</h2>
          ...
          <h4 class="mt-4 mb-3" id="disqualifying-conditions"><v-icon color="red">mdi-circle</v-icon> Disqualifying Conditions (must not be true)</h4>
          ...
          <h2 class="mt-7 mb-3" id="decision-process">4. Decision Process</h2>
