    ...
    <v-container class="fill-height" fluid>
      <v-row justify="center">
        <v-col cols="8" class="policy-content text-body-1">
          <h1 class="mb-5" id="hosting-policy-for-wikibase-cloud">Hosting Policy for Wikibase Cloud (pilot version)</h1>
          <h2 class="mt-7" id="purpose-and-scope">1. Purpose and Scope</h2>
          ...
          <h3 class="mb-3" id="target-audience">1.1 Target Audience</h3>
          <ul class="pl-5">
          ...
          <h2 class="mt-7" id="principles">2. Principles</h2>
          ...
          <h2 class="mt-7" id="hosting-criteria">3. Hosting Criteria</h2>
          ...
          <h4 id="required-conditions"><v-icon color="green">mdi-circle</v-icon> Required Conditions (must be true)</h4>
          ...
          <h4 id="disqualifying-conditions"><v-icon color="red">mdi-circle</v-icon> Disqualifying Conditions (must not be true)</h4>
          ...
          <h2 class="mt-7" id="decision-process">4. Decision Process</h2>
          ...
          <h3 class="mb-3" id="temporary-by-default-rule">4.1 Temporary-by-Default Rule</h3>
          ...
          <h3 class="mb-3" id="application">4.2 Application</h3>
          ...
          <h3 class="mb-3" id="ongoing-re-evaluation">4.4 Ongoing Re‑Evaluation</h3>
          <ul class="pl-5">
          ...
          <h3 class="mb-3" id="suspended-instances">4.5 Suspended Instances</h3>
          ...
          <h3 class="mb-3" id="appeals">4.6 Appeals</h3>
          ...
          <h3 class="mb-3" id="review-committee">4.7 Review Committee</h3>
          ...
          <h3 class="mb-3" id="migration-of-existing-instances">4.8 Migration of Existing Instances</h3>
          ...
          <h2 class="mt-7" id="transparency-and-communication">5. Transparency and Communication</h2>
          ...
          <h2 class="mt-7" id="policy-revision-and-updates">6. Policy Revision and Updates</h2>
