...
export const submitReview = async ({ wikiId, additionalInformation }) => {
...
export const loadWikiReviews = async (wikiId) => {
  const { data: { data } } = await axios.get(`/v1/wikis/${wikiId}/review_submissions`)
  return data
}
